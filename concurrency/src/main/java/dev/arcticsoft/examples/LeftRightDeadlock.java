 ...
 *
 * If one thread calls "leftRight" and another calls "rightLeft", and their
 * actions are interleaved, they will deadlock.
 *
 * The deadlock came about because the two threads attempted to acquire the same
 * locks in a different order.
 *
 * <NOTE_deadly_embrace>
 *
 * When a thread A holds lock L and tries to acquire lock M, but at the same
