...
public class SafePoint {
     ...
     *
     * If we provided separate getters for "x" and "y", then the values could
     * change between the time one coordinate is retrieved and the other,
     * resulting in a caller seeing an inconsistent value: an (x, y) location
     * where the vehicle never was
     */
