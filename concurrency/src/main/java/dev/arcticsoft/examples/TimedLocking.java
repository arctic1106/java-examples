 ...
 * single-threaded executor. Another approach is to use an exclusive lock to
 * guard access to the resource.
 *
...
public class TimedLocking {
    ...
    public boolean trySendOnSharedLine(final String message, final long timeout,
        ...
        /**
         * The timed "tryLock" makes it practical to incorporate exclusive
         * locking into such a time-limited activity.
         *
         * The timed tryLock is also responsive to interruption when you need
         * both timed and interruptible lock acquisition. (see
         * {@link InterruptibleLocking})
         */
