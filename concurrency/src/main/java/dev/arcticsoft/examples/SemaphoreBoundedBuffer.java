 ...
 *
 * SemaphoreBoundedBuffer implements a fixed-length array-based queue with
 * blocking "put" and "take" methods controlled by a pair of counting
 * semaphores.
 *
 * In practice, if you need bounded buffer you should use ArrayBlockingQueue or
 * LinkedBlockingDeque rather than rolling your own, but the technique used here
