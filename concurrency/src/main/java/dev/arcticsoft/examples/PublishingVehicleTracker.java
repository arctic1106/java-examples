 ...
 * additional constraints on the valid values of the vehicle locations. If it
...
public class PublishingVehicleTracker {
    ...
    /**
     * The getLocations() method returns an unmodifiable copy of the underlying
     * Map. Callers cannot add or remove vehicles, but could change the location
     * of one of the vehicles by mutating the SafePoint values in the returned
     * Map.
     *
