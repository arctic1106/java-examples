...
/**
 * FileCrawler shows a producer task that searches a file hierarchy for files
 * meeting an indexing criterion and put their names on the work queue.
 */
public class FileCrawler implements Runnable {
    ...
    public FileCrawler(final BlockingQueue<File> fileQueue,
        ...
        this.root = root;
        this.fileFilter = (final File f) -> f.isDirectory() || fileFilter.accept(f);
    }
