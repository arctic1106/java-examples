 ...
 * solution has been found, "solve" waits forever in the call to "getSolution".
 *
 ...
 *
 * One possible solution is to keep a count of active solver tasks and set the
...
public class PuzzleSolverNoSolutionFound<P, M> extends ConcurrentPuzzleSolver<P, M> {
    ...
    public PuzzleSolverNoSolutionFound(final Puzzle<P, M> puzzle) {
        super(puzzle);
    }
