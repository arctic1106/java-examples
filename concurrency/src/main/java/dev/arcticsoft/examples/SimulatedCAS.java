 ...
 *
 * CAS has three operands - a memory location V on which to operate, the
 * expected old value A, and the new value B.
 *
 * CAS atomically updated V to the new value B, but only if the value in V
 * matches the expected old value A; otherwise does nothing. In either case it
 * returns the value currently in V.
 *
 *
 ...
 *
 * SimulatedCAS illustrates the semantics of CAS (but not the implementation or
 * performance.)
 */
